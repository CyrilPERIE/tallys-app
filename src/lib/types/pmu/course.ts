import { Incident, Penetrometre, CommentaireSource } from "@/lib/types/pmu/common";
import { PoolID, PhotosArrivee, Cagnotte, Paris } from "@/lib/types/pmu/miscellaneous";
import { Hippodrome } from "@/lib/types/pmu/reusable";
